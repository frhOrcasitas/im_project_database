...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2026 at 01:32 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_FinalizeSale` (IN `p_sales_id` INT)   begin
UPDATE tbl_sales 
    SET sales_status = 'Completed', sales_paymentStatus = 'Paid' 
    WHERE sales_ID = p_sales_id;
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_restockproduct` (IN `p_id` INT, IN `p_qty` INT)   begin
UPDATE tbl_product 
    SET product_stockQty = product_stockQty + p_qty 
    WHERE product_ID = p_id;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_UpdateClientBalance` (IN `p_client_id` INT, IN `p_amount` DECIMAL(10,2))   begin
UPDATE tbl_client 
    SET client_outstandingbalance = client_outstandingbalance + p_amount 
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_calculatelossvalue` (`qty` INT, `unit_price` DECIMAL(10,2)) RETURNS DECIMAL(10,2) DETERMINISTIC BEGIN
    RETURN qty * unit_price;
END$$

CREATE DEFINER=`root`@`localhost` FUNCTION `fn_empdetails` (`emp_id` INT) RETURNS VARCHAR(100) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DETERMINISTIC begin
declare v_details varchar(100);
SELECT CONCAT(employee_name, ' (', employee_role, ')') INTO v_details
from tbl_employee where employee_id = emp_id;
return v_details;
end$$

CREATE DEFINER=`root`@`localhost` FUNCTION `fn_getstockstatus` (`stock` INT, `reorder` INT) RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DETERMINISTIC BEGIN
    IF stock <= 0 THEN RETURN 'OUT OF STOCK';
    ELSEIF stock <= reorder THEN RETURN 'LOW STOCK';
    ELSE RETURN 'HEALTHY';
    END IF;
END$$
...
(3, 'Bloxys', '12345678910', 'notrealemail@notreal.com', 'Davao City', 3, NULL, 3900.00),
...
(6, 'The Totally Real Canadian Tire', '12345678910', 'lolthisistotallyreal@notreal.com', 'Medicine Hat, Alberta, Canada', 12, '', 1825.00),
(7, 'SM Supermarket', '09234567891', 'frjs@notrealemail.com.ph', 'Bangkal, Davao City', 13, '', 0.00),
(8, 'JM\'s Superstore', '0999999999', 'jm@notrealemail.com', 'Digos, Davao del Sur', 17, '', 1860.00),
(9, 'fff', '09555879226', 'candsa@notrealemail.com', 'canada', 19, '', 0.00),
(10, 'Greatwall', '09854562143', '', 'Uyanguren, Davao City', 20, '', 936.00),
...
(30, 'Pierre Poilievre', 'Accountant', 'pp@letsbringithomenotreal.com', '09555555557', 'Battle River Crowfoot, Alberta, Canada', 'Male', '2026-03-10', 'Active', '1979-06-03', NULL, NULL, NULL),
...
(2, 'MBK 2.0kg', 9, '2.0kg x 6', 5, 68.00, 'Banana Ketchup', 380.00, NULL),
...
(5, 'Mommy\'s Premium Soy Sauce 3.8kg', 5, '3.8kg x 4', 30, 110.00, 'Fresh miki noodles', 420.00, NULL),
...
(8, '200g SUP Mommy\'s Premium Soy Sauce', 100, '200g x 36', 15, 8.00, '', 232.00, NULL),
(9, 'Mitoyo Soy Sauce', 100, 'container', 40, 260.00, NULL, 265.00, NULL),
(10, 'Mommy Vinegar (White/Brown)', 100, 'container', 50, 265.00, NULL, 268.00, NULL),
...
(16, 'Fresh Miki (Pancit Miki)', 198, 'kilogram', 30, 40.00, NULL, 155.00, NULL);
...
(43, 3, 1, '2026-03-14', NULL, 'Pending', NULL, 'Unpaid', 3900.00, NULL, NULL, NULL, NULL, 3900.00),
...
(51, 8, 1, '2026-03-14', NULL, 'Pending', NULL, 'Unpaid', 1460.00, NULL, 126, NULL, NULL, 1460.00),
(52, 6, 1, '2026-03-14', NULL, 'Pending', NULL, 'Unpaid', 1825.00, NULL, 126, NULL, NULL, 1825.00);
...
(41, 3, 30, NULL, 1650.00, 55.00, 'Cases', 0),
(41, 4, 25, NULL, 1700.00, 68.00, 'Cases', 0),
...
INSERT INTO `tbl_shipment` (`shipment_ID`, `manager_id`, `shipment_date`, `vehicle_id`, `shipment_total`, `sales_ID`) VALUES
(1, 3, '2026-02-23', 1, NULL, 1),
(2, 1, '2026-02-23', 1, NULL, 1),
(9, 1, '2026-03-06', 3, NULL, 20),
(32, 1, '2026-03-11', 1, NULL, 24),
(33, 1, '2026-03-11', 3, NULL, 30),
(34, 1, '2026-03-11', 4, NULL, 32),
(35, 3, '2026-03-11', 4, NULL, 31),
(36, 5, '2026-03-11', 1, NULL, 36),
(37, 5, '2026-03-11', 4, NULL, 37),
(38, 1, '2026-03-12', 3, NULL, 38),
(39, 3, '2026-03-12', 4, NULL, 40),
(40, 5, '2026-03-12', 1, NULL, 41),
(41, 0, '2026-03-12', 5, NULL, 42),
(42, 0, '2026-03-14', 5, NULL, 44);
...
--
ALTER TABLE `tbl_shipment`
  MODIFY `shipment_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
