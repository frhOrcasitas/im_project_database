            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full border border-slate-300 rounded-xl px-4 py-3 text-sm pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-black"
                />
                <button
                  type="button"
