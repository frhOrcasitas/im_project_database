        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-5 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-gray-400 text-gray-900 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-500"
                />
                {showCustomerDropdown && filteredCustomers.length > 0 && (
                  <div className="absolute z-10 bg-white border border-gray-300 rounded shadow-lg w-full mt-1 max-h-60 overflow-y-auto">
                    {filteredCustomers.map((c) => (
                      <div
                        key={c.client_ID} // FIXED: Using client_ID instead of id
              ...
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="w-full border border-gray-300 rounded px-3 py-2 text-sm bg-gray-100 text-gray-900 font-medium"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div>
                ...
                <input
                  type="text"
                  value={selectedCustomer?.client_contactNumber || ""}
                  readOnly
                  className="w-full border border-gray-300 rounded px-3 py-2 text-sm bg-gray-100 text-gray-900 font-medium"
                />
              </div>
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                rows={2}
                className="w-full border border-gray-400 rounded text-gray-900 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none font-medium"
              />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-5 shadow-sm">
            ...
            <input
              ...
              className="w-full border border-gray-400 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4 text-gray-900 font-medium"
            />
              ...
              {filteredProducts.map((product) => (
                <div
                  ...
                  className={`border-2 rounded-lg p-3 ${
                    product.status === "in_stock" ? "border-green-200 bg-green-50" : "border-gray-200 bg-white"
                  }`}
                >
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="w-full border border-gray-400 rounded px-2 py-1 text-sm text-gray-900 font-bold mb-2"
                    />
                    <button
                      onClick={() => handleAddToOrder(product)}
                      className="w-full bg-green-700 text-white text-xs font-bold py-2 rounded hover:bg-green-800 uppercase tracking-wider"
                    >
                      Add to Order
                    </button>
                  </div>
          ...
          <div className="bg-white rounded-lg border-2 border-gray-300 p-5 shadow-md sticky top-6">
            ...
            <div className="mb-4">
                ...
                <div className="relative">
                    ...
                    className="w-full border-2 border-gray-400 rounded pl-7 pr-3 py-2 text-sm focus:ring-2 focus:ring-green-500 font-bold text-gray-900"
                    />
                </div>
            </div>
            ...
            <div className="mt-4 space-y-2">
                <button onClick={handleCompleteSale} className="w-full bg-green-700 hover:bg-green-800 text-white py-3 rounded-lg font-black uppercase shadow-lg">
